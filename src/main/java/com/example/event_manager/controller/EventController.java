...
import com.example.event_manager.wrapper.DeletingTaskStatusInEventWrapper;
...
public class EventController {
    ...
    public String deleteTaskFromEvent(Model model, @RequestParam Long taskId, @RequestParam Long eventId){
...
//            .adhoc(event.getToDos().stream().filter(x -> !x.isPredefined()).collect(Collectors.toList()).get(0))
//            .build();
//
